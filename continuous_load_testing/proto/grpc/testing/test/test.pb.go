...
var file_grpc_testing_test_proto_rawDesc = string([]byte{
...
var file_grpc_testing_test_proto_goTypes = []any{
	(*empty.Empty)(nil),                                   // 0: grpc.testing.Empty
	(*messages.SimpleRequest)(nil),                        // 1: grpc.testing.SimpleRequest
	(*messages.StreamingOutputCallRequest)(nil),           // 2: grpc.testing.StreamingOutputCallRequest
	(*messages.StreamingInputCallRequest)(nil),            // 3: grpc.testing.StreamingInputCallRequest
	(*messages.ReconnectParams)(nil),                      // 4: grpc.testing.ReconnectParams
	(*messages.LoadBalancerStatsRequest)(nil),             // 5: grpc.testing.LoadBalancerStatsRequest
	(*messages.LoadBalancerAccumulatedStatsRequest)(nil),  // 6: grpc.testing.LoadBalancerAccumulatedStatsRequest
	(*messages.SetReturnStatusRequest)(nil),               // 7: grpc.testing.SetReturnStatusRequest
	(*messages.HookRequest)(nil),                          // 8: grpc.testing.HookRequest
	(*messages.ClientConfigureRequest)(nil),               // 9: grpc.testing.ClientConfigureRequest
	(*messages.SimpleResponse)(nil),                       // 10: grpc.testing.SimpleResponse
	(*messages.StreamingOutputCallResponse)(nil),          // 11: grpc.testing.StreamingOutputCallResponse
	(*messages.StreamingInputCallResponse)(nil),           // 12: grpc.testing.StreamingInputCallResponse
	(*messages.ReconnectInfo)(nil),                        // 13: grpc.testing.ReconnectInfo
	(*messages.LoadBalancerStatsResponse)(nil),            // 14: grpc.testing.LoadBalancerStatsResponse
	(*messages.LoadBalancerAccumulatedStatsResponse)(nil), // 15: grpc.testing.LoadBalancerAccumulatedStatsResponse
	(*messages.HookResponse)(nil),                         // 16: grpc.testing.HookResponse
	(*messages.ClientConfigureResponse)(nil),              // 17: grpc.testing.ClientConfigureResponse
}
